...
export default function HeroMain() {
  ...
  return (
    <div className='flex flex-col justify-center items-center  w-full md:h-[80vh] bg-transparent absolute top-[40%] md:top-[20%] z-10'>
      <div className='text-white text-center  w-[90%] md:w-[70%]'>
        ...
        <div>
          <button  onClick={handleDownload} className='border  rounded-md text-[#61D2B4] mt-6 py-2 px-6 tracking-wide text-xl font-bold hover:text-white hover:border-[#61D2B4]  ease-in-out'>Resume</button>
        </div>
      </div>
    </div>
  );
